...
import { useGetUserByIdQuery } from "../apiSlice/apiSlice";
      ...
      {/* <div className="modal">
        <div className="modal-content">
          ...
          <form className="upload-form">
            <svg
              aria-label="Ícone para representar mídia, como imagens ou vídeos"
              class="_ab6-"
              color="#262626"
              fill="#262626"
              height="77"
            ...
            <label htmlFor="image-upload">Pick file</label>
